...
let SSHListCommand = class SSHListCommand extends base_1.SSHBaseCommand {
    ...
    run(inputs, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { findSSHConfigHostSection, getSSHConfigPath, isSSHConfigDirective, loadSSHConfig, } = yield Promise.resolve().then(function () { return require('../../lib/ssh-config'); });
            ...
            const conf = yield loadSSHConfig(sshConfigPath);
            ...
            if (!cli_utils_1.isSSHKeyListResponse(res)) {
            ...
            const table = cli_utils_1.columnar(keysMatrix, {
                columnHeaders: ['fingerprint', 'name', 'annotation'],
            });
            this.env.log.nl();
            if (foundActiveKey) {
                this.env.log.info(`The row in ${chalk.bold('bold')} is your currently used key. To change, use ${chalk.green('ionic ssh use')}.\n`);
            }
