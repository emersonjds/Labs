...
*/
var championship = 'Liga dos Campeoes';
...
desafio.
*/
var teams = ['Real Madrid', 'Barcelona', 'Bayer de Munique', 'Werder Bremem', 'Shalke 04'];
...
function convertToHex(color) {
    ...
    return console.log('A cor passada foi ' + color + ' e seu hexadecimal é ' + hexa + ' .');
}
