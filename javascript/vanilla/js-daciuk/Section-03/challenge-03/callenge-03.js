...
pessoa.apresentacao = function() {
    ...
    if(pessoa.sexo === 'feminino') {
        return 'Olá , eu sou ' + letra + ' ' + pessoa.nomeCompleto() + ', tenho ' + pessoa.mostrarIdade() + 
        ...
        ano + ', meu peso é ' +pessoa.mostrarPeso() + ' e só hoje, eu ja caminhei ' + pessoa.caminhouQuantosMetros() + ' metros!';
    } else if (pessoa.caminhouQuantosMetros() === 1) {
        return 'Olá , eu sou o' + ' ' + pessoa.nomeCompleto() + ', tenho ' + pessoa.mostrarIdade() + 
        'anos , meu peso é ' +pessoa.mostrarPeso() + ' e só hoje, eu ja caminhei ' + pessoa.caminhouQuantosMetros() + metro + ' !';
    } else {
         return 'Olá , eu sou o' + ' ' + pessoa.nomeCompleto() + ', tenho ' + pessoa.mostrarIdade() + 
        'anos , meu peso é ' +pessoa.mostrarPeso() + ' e só hoje, eu ja caminhei ' + pessoa.caminhouQuantosMetros() + ' metros!';
    }
