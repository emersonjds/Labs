...
ContatosModule = __decorate([
    core_1.NgModule({
        imports: [common_1.CommonModule, contato_routing_module_1.ContatoRouteModule],
        declarations: [contatos_lista_component_1.ContatoListaComponent, contato_detalhe_component_1.DetalheContato],
        exports: [contatos_lista_component_1.ContatoListaComponent, contato_routing_module_1.ContatoRouteModule]
    })
], ContatosModule);
